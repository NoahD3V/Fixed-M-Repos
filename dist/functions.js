...
function loadingRepos() {
    myApp.showPreloader('Reloading Repos')
    setTimeout(function () {
        myApp.hidePreloader();
    }, 2000);
}        
...
function displayRepo(element, index, array) {
	jQuery.getJSON(element, function(data) {
			try {
var userRepo = jQuery.parseJSON(JSON.stringify(data));
			} catch (e) {
				console.log(e);
				return;
			}
		repoList += "<li class='swipeout'><a onclick=\"repoIcon=\'" + userRepo.repository.icon + "\'\" href=\"repositories/packages.html\" class=\"item-link\"><div class='swipeout-content'><div class='item-content'><div class='item-media'><img style='border-radius:21%;width: 29px;' src='" +
				...
				"</div><div class='item-subtitle' style='color: #666666;height: 19px; padding-bottom: 0px;'><font size=\"2\">" + userRepo.repository.description + "</font></div></div></div></div></a><div class='swipeout-actions-right'><a href='#' class='bg-red' onclick=\"deleteRepository('" + element + "');\" data-i18n=\"repos.delete\">Delete</a></div></li>";
...
function addRepository() {
	...
	myApp.prompt('Cydia Repositories do not work in AppsForever! You can find working repos <a href="https://repos.appsforever.org" class="color-blue external">here</a>!', 'Enter M-Repo URL',
		function(value) {
			...
			jQuery.getJSON(value, function(data) {
					try {
var repo = jQuery.parseJSON(JSON.stringify(data));
					} catch (e) {
						console.log(e);
